            ...
            <div className="w-full max-w-md mx-auto">
                ...
                <div className="bg-gray-50 dark:bg-neutral-900 p-6 sm:p-8 rounded-xl shadow-xl border border-gray-200 dark:border-neutral-700 w-full transition-colors duration-300">
                        ...
                        <div className="mb-6 p-4 bg-red-100 dark:bg-red-900/70 border-2 border-red-500 dark:border-red-600 rounded-lg shadow-lg animate-shake">
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1">
                                    <h3 className="text-base font-bold text-red-800 dark:text-red-200 mb-1">Signup Failed</h3>
                    ...
                    <form className="space-y-4" onSubmit={handleSubmit}>
                        ...
                        <div>
                            <label htmlFor="program" className="block mb-1 text-sm font-medium text-gray-700 dark:text-gray-300">Program (optional)</label>
                            <input
                                id="program"
                                type="text"
                    ...
                    <div className="text-center text-sm text-gray-600 dark:text-gray-400 mt-6">
                        ...
                        <Link href={redirectTo !== getDeviceSpecificRoute() ? `/login?redirect=${encodeURIComponent(redirectTo)}` : '/login'} className="text-blue-600 dark:text-white underline hover:text-blue-800 dark:hover:text-blue-400 transition-colors">Login</Link>
                    </div>
                </div>
            </div>
            <ThemeToggle />
