...
function ThemeSettings() {
  ...
  return (
    <div className="mt-8 border border-gray-200 dark:border-[rgb(var(--border-color))] rounded-xl p-6">
      ...
      <div className="space-y-6">
        ...
        <div>
          <div className="text-xs uppercase tracking-wide text-gray-500 dark:text-gray-400 mb-3">Color Theme</div>
          <div className="grid grid-cols-3 gap-3">
            <button
              onClick={() => setTheme('light')}
              className={`flex flex-col items-center gap-2 p-4 rounded-lg border-2 transition-all ${
                theme === 'light'
                  ? 'border-[#8b5cf6] bg-purple-50 dark:bg-purple-900/20'
                  : 'border-gray-200 dark:border-[rgb(var(--border-color))] hover:border-gray-300 dark:hover:border-gray-600'
              }`}
            >
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
            {theme === 'system' ? `Following system preference (currently ${actualTheme})` : `Using ${theme} mode`}
          </p>
        </div>

        {/* Seasonal Theme */}
        <div>
          <div className="text-xs uppercase tracking-wide text-gray-500 dark:text-gray-400 mb-3">Seasonal Theme</div>
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Christmas</span>
            </button>
          </div>
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
            {seasonalTheme === 'christmas' ? '🎄 Festive theme with special effects' : 'Standard theme'}
          </p>
        </div>
      </div>
    </div>
